...
$stmt->bind_param(
    ...
    $odometer, $license_plate, $seating_capacity,
    $owner_name, $dob, $address, $phone, $email, $license_number, $tax_id,
    $insurance_provider, $policy_number, $coverage_type,
    $registration_fee, $road_tax, $sales_tax, $payment_method,
    $dealer_info, $special_plate, $imagesString
);
...
h2 { font-weight: 700; color: #34495e; margin-bottom: 25px; }
h4 {
    font-weight: 600;
    font-size: 1.15rem;
...
input.form-control, select.form-select { border-radius: 8px; padding: 10px; }
.text-muted { font-size: 0.85rem; }
@media (max-width: 576px) { .row.g-3 > [class*='col-'] { margin-bottom: 10px; } }
</style>
</head>
<body>
        ...
        <div class="row g-3 mt-2">
            ...
            <div class="col-md-3">
                <select name="body_type" class="form-select" required>
                    ...
                    <option>Sedan</option><option>SUV</option><option>Truck</option><option>Hatchback</option><option>Coupe</option>
                </select>
            </div>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-4">
                <select name="coverage_type" class="form-select" required>
                    ...
                    <option>Liability</option><option>Comprehensive</option><option>Collision</option>
                </select>
            </div>
        </div>
    </div>
