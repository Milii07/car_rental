...
include $_SERVER['DOCUMENT_ROOT'] . '/new_project/helper/category.php';
include_once $_SERVER['DOCUMENT_ROOT'] . '/new_project/views/layout/header.php';
?>
                ...
                <div class="col-12">
                    <div class="card p-3 shadow-sm">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h5>Menaxhimi i Kategorive</h5>
                            <button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#addModal">
                                <i class="ri-add-fill"></i> Shto Kategori të Re
                            </button>
                        </div>
...
<div class="modal fade" id="addModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content p-4">
            ...
            <form method="POST">
                <div class="modal-body">
                    <input type="text" name="name" class="form-control" placeholder="Emri i kategorisë" required>
                </div>
                <div class="modal-footer">
