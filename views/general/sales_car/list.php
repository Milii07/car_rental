...
$cars = $mysqli->query("
    ...
    FROM cars c
    LEFT JOIN reservations r ON c.id = r.car_id AND r.status != 'cancelled'
...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            <div class="row mb-3">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Makina për Dorëzim / Marrje Sot</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">Makina</li>
                                <li class="breadcrumb-item active">Dorëzim / Marrje Sot</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <?php if (empty($cars)): ?>
                <div class="alert alert-info">Nuk ka makina për dorëzim ose marrje sot.</div>
            <?php endif; ?>
            ...
            <div class="row g-3">
                <?php foreach ($cars as $car):
                    ...
                    if (!empty($car['start_date']) && !empty($car['end_date'])) {
                            ...
                            <div class="card-body">
                                ...
                                <p class="mb-3"><strong>Gjendja:</strong>
                                    <span class="badge <?= $badge_class ?>"
                                        ...
                                        data-bs-html="true"
                                        data-bs-title="Klienti: <?= htmlspecialchars($car['client_name']) ?><br>Periudha: <?= $car['start_date'] ?> - <?= $car['end_date'] ?><br><?= $days_reserved ?> ditë të rezervuara">
                                        <?= $today_status ?>
                                    </span>
                                </p>
                            </div>
                                ...
                                <div class="modal-body row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="card p-3 mb-3">
                                            ...
                                            <?php if (!empty($car['client_name'])): ?>
                                                <p><strong>Klienti:</strong> <?= htmlspecialchars($car['client_name']) ?> (<?= $days_reserved ?> ditë)</p>
